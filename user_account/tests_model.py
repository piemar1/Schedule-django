...
class UserMethodTests(TestCase):
    ...
    def test_get_short_name(self):
        """Test for method get_short_name - should return name of user object. """
        user = create_user()
        self.assertEqual(user.get_short_name(), 'Jan')

    def test_is_superuser(self):
        """Test for method is_superuser - should return False for user object. """
        user = create_user()
    ...
    def test_module_perms(self):
        """Test for method module_perms - should return False for user object. """
        user = create_user()
        self.assertEqual(user.has_module_perms(app_label=None), False)

    def test_get_last_login(self):
        """Test for method get_last_login - should return time of last login for user object.
        (time = timezone.now())
        """
        time = timezone.now()
    ...
    def test_get_full_name(self):
        """Test for method get_full_name - should return full name of user object."""
        user = create_user()
...
class SuperUserTests(TestCase):
    ...
    def test_get_email(self):
        ...
        self.assertEqual(super_user.get_email, 'example_super_user_mail@gmail.com')

    def test_get_short_name(self):
        """Test for method get_short_name - should return name of super_user object. """
        super_user = create_superuser()
    ...
    def test_is_staff(self):
        """Test for method is_staff - should return True for super_user object. """
        super_user = create_superuser()
        self.assertEqual(super_user.is_staff, True)

    def test_has_perm(self):
        """Test for method has_perm - should return True for super_user object. """
        super_user = create_superuser()
    ...
    def test_get_last_login(self):
        ...
        should return time of last login for super_user object. (time = timezone.now())
        """
        time = timezone.now()
    ...
    def test_get_full_name(self):
        """Test for method get_full_name - should return full name of super_user object."""
        super_user = create_superuser()
